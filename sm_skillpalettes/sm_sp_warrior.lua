...
function downed:IsActive(context)
	return (context.skillbar~=nil  and context.skillbar[GW2.SKILLBARSLOT.Slot_1]~=nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 14390)	
end
...
function drowning:IsActive(context)
	return (context.skillbar~=nil  and context.skillbar[GW2.SKILLBARSLOT.Slot_1]~=nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 14463)	
end
...
function set:CanActivate(context)
	return (context.skillbar~=nil  and context.skillbar[GW2.SKILLBARSLOT.Slot_10]~=nil  and context.skillbar[GW2.SKILLBARSLOT.Slot_10].id == 14483 and context.skillbar[GW2.SKILLBARSLOT.Slot_10].cancast)
end
function set:Activate(context)
	if ( context.skillbar~=nil ) then
		if (context.skillbar[GW2.SKILLBARSLOT.Slot_10]~=nil and context.skillbar[GW2.SKILLBARSLOT.Slot_10].id == 30792) then Player:CastSpell(GW2.SKILLBARSLOT.Slot_10) end
	end
end
function set:Deactivate(context)
	if ( context.skillbar~=nil ) then
