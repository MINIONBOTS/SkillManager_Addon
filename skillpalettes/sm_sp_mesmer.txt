...
function sword_mh:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_2] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_2].id == 10334)
end
...
function sword_ambush_mh:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 45230)
end
function sword_ambush_mh:CanActivate(context)
	return context.player.alive and context.player.canswapweaponset and context.player.swimming == GW2.SWIMSTATE.NotInWater and
		(context.player.mainhand == GW2.WEAPONTYPE.Sword or context.player.mainhand_alt == GW2.WEAPONTYPE.Sword) and
		(context.player.weaponset == 4 or context.player.weaponset == 5) and
		context.player.transformid == 0 and
		context.player.buffs and
		context.player.buffs[40408]
end
...
function sword_oh:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_5] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_5].id == 10174)
end
...
function axe:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_2] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_2].id == 45243)
end
...
function axe_ambush:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 44321)
end
...
function greatsword:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10219)
end
...
function greatsword_ambush:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 44241)
end
...
function pistol:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_4] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_4].id == 10175)
end
function pistol:CanActivate(context)
	return context.player.alive and context.player.canswapweaponset and context.player.swimming == GW2.SWIMSTATE.NotInWater and
		(context.player.offhand == GW2.WEAPONTYPE.Pistol or context.player.offhand_alt == GW2.WEAPONTYPE.Pistol) and
		(context.player.weaponset == 4 or context.player.weaponset == 5) and
		context.player.transformid == 0
end
...
function scepter:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil) and
		(
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10289 or
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10290 or
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10291
		)
end
function scepter:CanActivate(context)
	return context.player.alive and context.player.canswapweaponset and context.player.swimming == GW2.SWIMSTATE.NotInWater and
		(context.player.mainhand == GW2.WEAPONTYPE.Scepter or context.player.mainhand_alt == GW2.WEAPONTYPE.Scepter) and
		(context.player.weaponset == 4 or context.player.weaponset == 5) and
		context.player.transformid == 0
end
...
function scepter_ambush:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 42304)
end
...
function staff:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10273)
end
...
function staff_ambush:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 40184)
end
...
function focus:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_5] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_5].id == 10282)
end
function focus:CanActivate(context)
	return context.player.alive and context.player.canswapweaponset and context.player.swimming == GW2.SWIMSTATE.NotInWater and
		(context.player.offhand == GW2.WEAPONTYPE.Focus or context.player.offhand_alt == GW2.WEAPONTYPE.Focus) and
		(context.player.weaponset == 4 or context.player.weaponset == 5) and
		context.player.transformid == 0
end
...
function torch:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_4] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_4].id == 10285)
end
...
function shield:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_5] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_5].id == 30643)
end
...
trident.skills_luacode = {
	...
	[10327] = {
		slot = GW2.SKILLBARSLOT.Slot_3,
		activationtime = 0.75,
		icon = "Imminent Voyage"
	},
	[10328] = {
		slot = GW2.SKILLBARSLOT.Slot_4,
		activationtime = 0.5,
		icon = "Phantasmal Whaler"
	},
	[10260] = {
		slot = GW2.SKILLBARSLOT.Slot_5,
		activationtime = 0.75,
...
function trident:IsActive(context)
	...
	(
		context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
		(
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10258 or
			context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 39959
		)
	)
end
...
function spear:IsActive(context)
	return context.player.alive and
		(context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_3] ~= nil and
			context.skillbar[GW2.SKILLBARSLOT.Slot_3].id == 10251)
end
...
function downed:IsActive(context)
	return (context.skillbar ~= nil and context.skillbar[GW2.SKILLBARSLOT.Slot_1] ~= nil and
		context.skillbar[GW2.SKILLBARSLOT.Slot_1].id == 10196)
end
