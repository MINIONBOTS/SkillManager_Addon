...
local sm_condition_entitycount = class('Casting (Last ID)', sm_condition)
sm_condition_entitycount.uid = "Casting (Last ID)"
...
function sm_condition_entitycount:Evaluate(skill,context)	
	...
	return castinfo and castinfo.lastskillid and castinfo.lastskillid == self.skillid	
end
