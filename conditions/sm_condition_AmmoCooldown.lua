-- Cooldown condition
local sm_condition_cooldown = class('Ammo Cooldown', sm_condition)
sm_condition_cooldown.uid = "Ammo Cooldown"
...
function sm_condition_cooldown:Render(id) -- need to pass an index value here, for the unique IDs used by imgui	
	...
	GUI:Text(GetString("Ammo Cooldown"))
	GUI:SameLine()
