...
local sm_condition_combatstate = class('Clone', sm_condition)
sm_condition_combatstate.uid = "Clone"
sm_condition_combatstate.targets = { [1] = GetString("Player is"), [2] = GetString("Target is"), [3] = GetString("Friend is"),  }
sm_condition_combatstate.operators = { [1] = GetString("a Clone"), [2] = GetString("Not a Clone"),  }
