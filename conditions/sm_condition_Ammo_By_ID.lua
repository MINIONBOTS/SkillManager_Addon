-- Cooldown condition
local sm_condition_cooldown = class('Ammo - by Skill ID', sm_condition)
sm_condition_cooldown.uid = "Ammo - by Skill ID"
...
function sm_condition_cooldown:Render(id) -- need to pass an index value here, for the unique IDs used by imgui	
	...
	GUI:Text(GetString("Ammo of Skill ID"))
	GUI:SameLine()
	
	GUI:PushItemWidth(100)
	self.skillid, changed = GUI:InputInt("##sm_condition_ammo1"..tostring(id),self.skillid, 1,2,GUI.InputTextFlags_CharsDecimal+GUI.InputTextFlags_CharsNoBlank)	
